...
// Source: github.com/dghubble/sessions (interfaces: Store)
...
func (m *MockStore) New(arg0 string) *sessions.Session {
	m.ctrl.T.Helper()
...
func (m *MockStore) Save(arg0 http.ResponseWriter, arg1 *sessions.Session) error {
	m.ctrl.T.Helper()
